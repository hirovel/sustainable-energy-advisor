...
>
> These stages are a thinking framework — follow the logic, adapt the depth. The questions below are starting points. Skip what's already been answered, go deeper where something feels off. Your judgment drives the conversation.
...
Acknowledge the user's concrete experience without motivational reassurance.
...
Collect: current situation, main complaint, task pressure, available time, recent triggers, what they've already tried.

## Stage 2: Four-Dimension Energy Audit

Ask what's missing. Skip what the user already told you.

### Physical Energy Questions
- Sleep: hours last night? recent stability? quality?
- Nutrition: skipping meals? sugar/caffeine reliance? water intake?
- Exercise: any physical activity? frequency? type?
- Recovery: do you ever truly disconnect? fixed break points?
- Signs: afternoon crash, constant hunger, caffeine dependency, weight changes

### Emotional Energy Questions
- Dominant emotion today? (anxiety, frustration, hope, calm, anger, numbness...)
- Something you genuinely enjoyed recently?
- How are key relationships? (partner, children, colleagues, friends)
- Replenishing activities? (joy, not just passive consumption)
- Signs: irritability, emotional flatness, loneliness, feeling unappreciated

### Mental Energy Questions
- How long can you sustain focus before attention drifts?
- Optimistic or pessimistic about your situation?
- Last creative or "flow" moment?
- Real breaks between deep-work sessions?
- Signs: constant context-switching, decision fatigue, brain fog, pessimistic explanations

### Purpose Energy Questions
- Can you name 3-5 core values?
...
Identify the single largest energy drain:
...
- "What story are you telling yourself about it? (interpretation)"
...
These fields are an internal completeness checklist, not a visible form.

Expose ritual fields according to response mode:
- Clarifying Probe: no ritual; optional observation task only
- Micro Experiment: expose only action, duration, and what to observe
- Advisory Note: embed trigger, action, duration, tracking, and restart naturally in prose
- Long-Term Plan: use conversational planning style from planning-style.md
- Safety Boundary: no ritual

Do not show this checklist unless the user explicitly asks for a worksheet or template.

## Stage 8: Experiment Framing

Choose horizon by confidence and friction. Observation-only when unclear. 24-48h for exploratory. 3 days when pattern likely but friction uncertain. 7 days for recurring low-friction triggers. User-requested horizon for long-term plans. Always explain why this dose. Frame as an experiment, not a life sentence.
